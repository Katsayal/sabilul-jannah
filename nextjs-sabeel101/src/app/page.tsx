...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* 2. MISSION QUICK-STATS (Keeping it Clean White for transition) */}
      ...
      {/* 3. OUR ACTIVITIES (Intense Blue Background) */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {activities.map((activity) => (
              <Link 
                key={activity._id} 
                href={activity.link || "#"}
                className="group relative h-80 rounded-[2.5rem] overflow-hidden shadow-2xl transition-all"
              >
      ...
      {/* 4. TESTIMONIALS SECTION (Intense Golden Background) */}
      <section className="py-24 bg-[#F3E5AB] relative overflow-hidden"> {/* Deeper Golden Parchment */}
      ...
      <section className="py-24 text-center px-6 bg-white">
        <div className="container mx-auto max-w-4xl bg-secondary rounded-[4rem] p-12 md:p-20 text-white shadow-2xl relative overflow-hidden">
           <div className="relative z-10">
              ...
              <p className="text-white/80 mb-12 text-xl max-w-xl mx-auto">Your support translates into immediate relief for those in need.</p>
